...
public class Functions_DoublyLL {
    ...
    private Node createNewRecord(int studentID, String lastName, String firstName,  String course,
                                 int yearLevel, String section, String status) throws Exception{
    ...
    public void insertStudent(int studentID, String firstName, String lastName, String course,
                              int yearLevel, String section, String status) throws Exception{

        Node student = createNewRecord(studentID, firstName, lastName, course, yearLevel, section, status);
    ...
    //Method that Search student records by ID
    ...
    //Method that Search student records by name
    public void searchByName(String searchName){
        ...
        if(ptr != null){
            while (ptr != null){
                i++;
                if((ptr.firstName.equalsIgnoreCase(searchName)) || (ptr.lastName.equalsIgnoreCase(searchName))){
                    found++;
                    break;
                }
                ptr = ptr.next;
    ...
    //Method that Search student records by course
    public void searchByCourse(String searchCourse){
        ...
        if(ptr != null){
            ...
            if(found == 1){
                ...
                out.print(searchCourse + " is not found.");
            }
        } else{
            //if ptr points to start that is null,
            //this statement will display
    ...
    //Display student based on year level
    ...
    //Method that displays all students in ascending order based on year level
    ...
    //Method that displays all students in ascending order based on student ID
    public void displayAscendID() throws Exception{
    ...
    //Method that displays all the courses in ascending order
    ...
    //Method that Display how many students are currently enrolled in a particular course
    public int getCurrentEnrolled() throws Exception{
    ...
    //Method that Displays how many students are currently active
    public void getTotalStatus() throws Exception{

        int active = 0;      //initializing count
        int inactive = 0;
        Node ptr = start;   //pointer variable pointing to the start node
        ...
        out.println();
        out.print("Number of active students : " + active);
        out.print("\nNumber of inactive students : " + inactive);
    }

    //Method that deletes a student based on the ID
    ...
    public void display() throws Exception{
        ...
        if(start == null){
            ...
            out.println("ID" + "\t\t\t" + "Name" + " " + "\t\t\t" + "Course" + "\t\t\t" + "Section" + "\t\t\t"
                    + "Year Level" + "\t\t" + "Status");
